<div class="row">
    <form class="col s12">
        <div class="row">
            ...
            <div class="input-field col s12 m4 l6">
                ...
                <select>
                    ...
                    <option value="Alunos do terceiro ano do ensino médio (tendo no mínimo 16 anos)">Alunos do
                        terceiro ano do ensino médio (tendo no mínimo 16 anos)
                    </option>
                    <option value="Pessoas que não possuem vínculo com a UFSCar">Pessoas que não possuem vínculo com
                        a UFSCar
                    </option>
                </select>
        ...
        <div class="row">
            <div class="col s12 m4 l3"></div>
            <div class="input-field col s12 m4 l6">
                <container><label for="text">Escola em que estuda e cidade (Se for aluno do ensino médio)</label>
                </container>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m4 l6">
                ...
                <select>
                    <option value="" disabled selected></option>
                    <option value="Sim, e fui chamado">Sim, li e estou ciente dos termos do processo seletivo.
                    </option>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 m4 l6">
                ...
                <select>
                    <option value="" disabled selected></option>
                    <option value="Mídias Sociais (Facebook, Whatsapp, etc)">Mídias Sociais (Facebook, Whatsapp,
                        etc)
                    </option>
                    <option value="Recomendação">Recomendação</option>
                    <option value="Outras Mídias (Jornais, Revistas, Televisão)">Outras Mídias (Jornais, Revistas,
                        Televisão)
                    </option>
        ...
        <div class="col s12 m4 l3"></div>
        <div class="input-field col s12 m4 l6">
            <container><label>Você está ciente de que as aulas da Share acontecem na UFSCar Sorocaba, próximo à
                    Salto de Pirapora?</label></container>
            <select>
                <option value="" disabled selected></option>
                <option value="Sim">Sim</option>
                <option value="Não">Não</option>
...
<div class="row">
    <div class="col s12 m4 l3"></div>
    <div class="input-field col s12 m4 l6">
        <container><label for="textarea1">Como voce descreveria a sua disponibilidade de tempo atualmente?</label>
        </container>
...
<div class="row">
    ...
    <div class="input-field col s12 m4 l6">
        ...
        <select>
            ...
            <option value="Conhecer mais sobre a área/ sanar minha curiosidade">Conhecer mais sobre a área/ sanar
                minha curiosidade
            </option>
            <option value="Me preparar para provas (vestibulares,  provas da faculdade)">Me preparar para provas
                (vestibulares, provas da faculdade)
            </option>
...
<div class="row">
    <div class="col s12 m4 l3"></div>
    <div class="input-field col s12 m4 l6">
        <container><label>Você está ciente de que desistir do curso, sem explicação plausível, impossibilitará o
                candidato de se inscrever para qualquer outro curso da Share, além de prejudicar sua turma?</label>
        </container>
        <select>
            <option value="" disabled selected></option>
            <option value="Sim">Sim</option>
...
<div class="row">
    <div class="col s12 m4 l3"></div>
    <div class="input-field col s12 m4 l6">
        <h6>Para finalizar, pedimos para que você escreva entre 5 e 10 linhas por que gostaria de fazer um curso na
            Share. Lembre-se, esse é um dos critérios mais importantes para ser selecionado (exceto: curso
            português).</h6>
        <textarea id="textarea1" class="materialize-textarea"></textarea>
