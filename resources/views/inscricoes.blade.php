		...
		<main>
			...
			<div class="row">
			    ...
			    <div class="center col s12 m12 l3">
			    	<a href="edicao.html" class="center atualizar waves-effect waves-light btn">Atualizar perfil</a>
	
					<h5>Seus cursos:</h5>
					<ul class="collection with-header">
				        <li class="collection-item">
							<span class="title"><b>Violão</b></span>
							<a href="inscricoes.html" class="secondary-content"><i class="material-icons">delete</i></a>
